<script>
import SchedaProdotto from './SchedaProdotto.vue'
    ...
    <main>
        ...
        <div class="container">
            ...
            <div class="products">
                ...
                <SchedaProdotto v-for="(product, index) in products" :key="index" :details="product"
                    :linkImg="product.thumb" :nameImg="product.series" />
            </div>
